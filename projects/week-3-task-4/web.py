        ...
        try:
            ...
            if self.command == "PATCH":
                if resource == "memory":
                    ...
                    try:
                        task = task_action(chat["task"], data)
                    except RuntimeError as error:
                        raise RequestError(409, "invalid_transition", str(error)) from error
                    chat = store.update_state(owner_id, chat["id"], "task", task)
                else:
